...
and a simulated payment ledger**. A reference deployment in `us-east-1` passed the
live acceptance suite. The repository contains local OpenTelemetry traces, a
sanitized live scenario report, and reviewed CloudWatch evidence.

## Start here

1. Follow [AWS setup and deployment](docs/AWS_SETUP.md).
2. Review the [live and local evidence](evidence/README.md).
...
| `evidence/` | Local results and reviewed cloud evidence |
